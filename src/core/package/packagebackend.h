...
public:
    ...
    { Q_UNUSED(required); Q_UNUSED(error); return false; }
    ...
    { Q_UNUSED(services); Q_UNUSED(error); return false; }
    ...
    { Q_UNUSED(paths); Q_UNUSED(error); return false; }
    ...
    { Q_UNUSED(units); Q_UNUSED(error); return false; }
