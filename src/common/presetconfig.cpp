...
{
    switch (family) {
    case DistroProbe::Family::Debian: return "apt";
    case DistroProbe::Family::Fedora: return "dnf";
    case DistroProbe::Family::Arch:   return "pacman";  // 预留，尚未实现后端
    case DistroProbe::Family::Suse:   return "zypper";  // 预留，尚未实现后端
    case DistroProbe::Family::Unknown:
    default:                          return QString();
    }
}

QVariantMap PresetConfig::defaultOptionsFor(const QString &backendId, DistroProbe::Family family)
{
